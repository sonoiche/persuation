<section class="my-36 px-16 bg-f5 flex justify-center w-full">
    <div>
        ...
        <div class="mt-10 relative z-10">
            <div class="mb-4 flex justify-center">
                <div class="w-full">
                    <ul class="flex flex-wrap justify-evenly border-b-gray-500 border-b text-2xl font-bold tracking-wider font-malishroman text-center text-white relative tabs" role="tablist">
